    ...
    return (
        <div className="block relative w-full h-screen overflow-hidden z-0">
            ...
            <div className="relative z-10 h-full flex flex-row items-center justify-center text-white p-4">
                ...
                <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mh-128shrink-3 ">
                    <div className="flex flex-col md:flex-row items-center justify-center gap-0">
                        ...
                        <div className="flex flex-col items-center max-w-2xl ">
                            <span className="text-xl sm:text-2xl md:text-4xl font-Ysabeau font-bold text-center">
                                IIT Roorkee's Annual Career Odyssey
                            </span>

                            <div className="w-full h-1 bg-gradient-to-r from-[#E89005] via-[#C10000] to-[#E89005] my-4" />

                            <h2 className="text-7xl md:text-9xl font-Aquire font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#E89005] via-[#C91F01] to-[#C10000] text-center">
                                Comet'25
                            </h2>

                            <div className="w-full h-1 bg-gradient-to-r from-[#E89005] via-[#C10000] to-[#E89005] my-4" />

                            <div className="flex flex-row items-center justify-between w-full text-base md:text-2xl font-bold font-Ysabeau gap-4 md:gap-8">
                                <span className="">Think Beyond, Lead Beyond</span>
