...
const NavBar = () => {
  ...
  return (
    ...
    >
            ...
            {navItems.map((item) => (
              <a
                ...
                className={`whitespace-nowrap transition-colors ${
                  activeSection === item.label.replace(/\s+/g, '') ? "text-yellow-400" : "text-white"
      ...
      <div
        className={`fixed top-0 right-0 h-full w-72 bg-black transform transition-transform duration-300 ease-in-out lg:hidden z-50 ${
